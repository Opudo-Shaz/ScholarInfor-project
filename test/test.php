...
if (isset($_SESSION["sessData"])) {
  $u = PrivilegedUser::getByUsername($_SESSION["sessData"]);
}

if ($u->hasPrivilege("create_users")) {
  echo "heeeeeeuuuu";
}
      ...
      <div class="page-wrapper">
        ...
        <div class="page-content">
          <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
            <h3 class="pb-2">STUDENT DETAILS</h3>
...
?>
            <div class="row mt-0 align-items-center g-3">
            ...
            <div class="row mb-3">
              ...
              <div class="mb-3 ps-4">
                <div class="form-check form-check-inline">
                  <input type="radio" class="form-check-input" name="student_status" value="ongoing" id="ongoingRadio">
                  <label class="form-check-label" for="ongoingRadio"> Ongoing </label>
                  <div class="form-check form-check-inline">
                    <input type="radio" class="form-check-input" name="student_status" value="dropout"
                      id="dropoutRadio">
              ...
              <div class="mb-3 col-sm-5">
                ...
                <select class="form-control" disabled id="dropoutReason" name="dropout_reason">
