        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="margin-top:80px !important;">
                ...
                <div class="container">
                    ...
                    $sql = "SELECT * FROM student WHERE student_status = 'dropout' AND verification_status='verified'";
                   // Only select students with status 'dropout'
                        ...
                        <tbody>
                            <?php while ($user = mysqli_fetch_assoc($result)): ?>
                                <tr>
                                    ...
                                    <td><?php echo $user['dropout_reason']; ?></td>
                                    <td><?php echo $user['other_dropout_reason']; ?></td>
