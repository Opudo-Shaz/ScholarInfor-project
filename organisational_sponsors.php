...
if (empty($userData) || !($u->hasRole("Admin") || $u->hasRole("Editor") || (!$u->hasRole("Super_admin")))) {
    ...
    header('location:logout.php');
        ...
        <head>
            ...
            <title>Organisational Sponsors Details</title>
            ...
            <?php @include "includes/sidebar.php" ?>
                ...
                <?php @include "includes/header.php" ?>
                    ...
                    <div class="container-fluid" style="margin-top:80px !important;">
                        ...
                        <div class="container">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <h3>Organisational Sponsors Details</h3>
                        ...
                        $sql = "SELECT * FROM sponsors WHERE sponsor_type = 'Institutional'";
...
<table id="tblStudent">
    ...
    <script src="assets/js/sweetalert2.min.js"></script>                <script>
