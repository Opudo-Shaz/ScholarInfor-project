                    ...
                    <div class="form-group">
                        <div class="row align-items-center justify-content-between ">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="sub_cnty" class="form-control sub_county" disabled  name="sub_county">
...
<div class="text-danger error" id="subCountyError"></div>
                            ...
                            <fieldset class="mb-3">
                                ...
                                <label for="schoolLevel" class="form-check-label">
                                    <input type="radio" id="schoolLevel" class="form-check-input" name="school_level"
                                        value="Secondary" <?php echo (isset($row['school_level']) && $row['school_level'] === 'Secondary') ? 'checked' : ''; ?> />
                                    Secondary
                                </label>
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input ms-5" name="school_level"
                                        value="Primary" <?php echo (isset($row['school_level']) && $row['school_level'] === 'Primary') ? 'checked' : ''; ?> />
                                    Primary
                                </label>
                  ...
                  <div>
                    <input type="submit" class="btn btn-primary justify-content-start text-uppercase" value="update"
                      name="submit" />
                  </div>
                  <div>
