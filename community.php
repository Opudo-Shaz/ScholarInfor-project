...
if (empty($userData) || !($u->hasRole("Admin") || $u->hasRole("Editor") || (!$u->hasRole("Super_admin")))) {
  ...
  ?>
    ...
    <head>
      <title>ScholarInfo --Community</title>
    </head>
      ...
      <div class="page-content">
        <div class="container-fluid">
          <div class="card p-4 rounded-3">
            <h3 class="p-3">ADD COMMUNITY DETAILS</h3>

            <form role="form" id="CommunityForm" method="post" action="community_process.php">
...
<i data-feather="alert-circle"></i>';
              ...
              <div class="row align-items-center mb-3 col-lg">
                <div class="mb-3 ">
                  ...
                  <input type="text" name="community_name" maxlength="50" placeholder="Community Name" class="form-control"
                    required>
                  <div class="text-danger error" id="CommunityNameError"></div>
                </div>

                <!--Insert comunity type -->
                <div class="mb-3">
    <label for="community_type">Community Type</label>
    <select id="community_type" class="form-control" name="community_type" required>
        <option value="" disabled selected>Select Community Type</option>
        <option value="Ward">Ward</option>
        <option value="Village">Village</option>
    </select>
    <div class="text-danger error" id="CommunityTypeError"></div>
</div>
                <div class="mb-3">
                ...
                <div class="row align-items-center mb-3 col-lg">
    <div class="mb-3 ">
        <label for="cm_leader_name"> Community Leader Name</label>
        <input type="text" name="cm_leader_name" maxlength="50" placeholder=" Community Leader Name" class="form-control" required>
        <div class="text-danger error" id="CmLeaderNameError"></div>
    </div>

    <div class="mb-3 ">
        <label for="cm_leader_phone"> Community Leader Phone Number</label>
        <input type="text" name="cm_leader_phone" maxlength="10" placeholder=" Community Leader Phone Number" class="form-control" required>
        <div class="text-danger error" id="CmLeaderPhoneError"></div>
    </div>

    <div class="mb-3 ">
        <label for="cm_leader_email"> Community Leader Email</label>
        <input type="text" name="cm_leader_email" maxlength="255" placeholder=" Community Leader Email" class="form-control" required>
        <div class="text-danger error" id="CmLeaderEmailError"></div>
    </div>
</div>  
    <div class="mb-3 ">
        <label for="asscm_leader_name">Assistant Community Leader Name</label>
        <input type="text" name="asscm_leader_name" maxlength="50" placeholder="Assistant Community Leader Name" class="form-control" required>
        <div class="text-danger error" id="AsscmLeaderNameError"></div>
    </div>

    <div class="mb-3 ">
        <label for="asscm_leader_phone">Assistant Community Leader Phone Number</label>
        <input type="text" name="asscm_leader_phone" maxlength="10" placeholder="Assistant Community Leader Phone Number" class="form-control" required>
        <div class="text-danger error" id="AsscmLeaderPhoneError"></div>
    </div>

    <div class="mb-3 ">
        <label for="asscm_leader_email">Assistant Community Leader Email</label>
        <input type="text" name="asscm_leader_email" maxlength="255" placeholder="Assistant Community Leader Email" class="form-control" required>
        <div class="text-danger error" id="AsscmLeaderEmailError"></div>
    </div>
</div>
                <div class="row align-items-center mb-3 col-lg">
                </div>
      ...
      <script>
        ...
        document.getElementById('CommunityForm').addEventListener('submit', function (event) {
          var valid = true;
          var CommunityName = document.getElementsByName('Community_name')[0].value.trim();
          var county = document.getElementsByName('county')[0].value;
          var subCounty = document.getElementsByName('sub_county')[0].value;
          var CommunityLevel = document.querySelector('input[name="Community_level"]:checked');
          ...
          if (CommunityName === '') {
            document.getElementById('CommunityNameError').innerHTML = 'Community Name is required.';
            valid = false;
          }
          ...
          if (!CommunityLevel) {
            document.getElementById('CommunityLevelError').innerHTML = 'Please select Community Level.';
            valid = false;
          }
        ...
        // Event listener to clear Community Level error when radio buttons change
        var CommunityLevelRadios = document.querySelectorAll('input[name="Community_level"]');
        for (var i = 0; i < CommunityLevelRadios.length; i++) {
          CommunityLevelRadios[i].addEventListener('change', function () {
            document.getElementById('CommunityLevelError').innerHTML = '';
          });
        }
      </script>
